...
@property (nonatomic, strong) UIColor *titleColor;          // Default is #454545.
@property (nonatomic, strong) UIColor *detailColor;         // Default is #333333.
@property (nonatomic, strong) UIColor *splitColor;          // Default is #E3E3E3.

@property (nonatomic, strong) UIColor *itemNormalColor;     // Default is #454545. effect with MMItemTypeNormal
@property (nonatomic, strong) UIColor *itemHighlightColor;  // Default is #FF5C39. effect with MMItemTypeHighlight
@property (nonatomic, strong) UIColor *itemPressedColor;    // Default is #EFEDE7.

@property (nonatomic, strong) NSString *defaultTextOK;      // Default is "OK".
@property (nonatomic, strong) NSString *defaultTextCancel;  // Default is "Cancel".
@property (nonatomic, strong) NSString *defaultTextConfirm; // Default is "Confirm".
